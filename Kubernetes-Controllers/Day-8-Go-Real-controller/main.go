...
func (a *AppSpec) GetName(name string, replicas int) (string, int) { //* menas Pointer Only, So that update the values of original struct,
	...
	return a.Name, a.Replicas // It's return name and replicas in string format
}
